...
class PDFGenerator {
    ...
    generateHTML() {
        ...
        return `
            <div class="bill-template" style="max-width: 600px; margin: 0 auto; font-family: 'Poppins', sans-serif; padding: 0; border: 2px solid #000000ff;">
                <div class="bill-header" style="border-bottom: 2px solid #000000ff; padding: 0.2rem 0.5rem; margin-bottom: 0.2rem;">
    ...
    " alt="Sagar Cafe Logo" style="width: 60px; height: 60px; display: block;">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        <p style="color: #7f8c8d; font-size: 0.6rem; margin: 0; line-height: 1.2;">☎️ +91 9174849029</p>
                        <p style="color: #7f8c8d; font-size: 0.6rem; margin: 0; line-height: 1.2;">📍 Jabalpur Road, Makronia, Sagar</p>
                    </div>
                </div>

                <div class="bill-info" style="margin-bottom: 0.2rem; font-size: 0.65rem; padding: 0 0.5rem; color: #2c3e50;">
