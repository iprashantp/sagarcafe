    ...
    generateHTML() {
        ...
        return `
            <div class="bill-template" style="max-width: 600px; margin: 0 auto; font-family: 'Poppins', sans-serif; padding: 0; border: 2px solid #d4af37;">
                <div class="bill-header" style="border-bottom: 2px solid #d4af37; padding: 0.3rem 0.75rem; margin-bottom: 0.3rem; display: flex; align-items: center; gap: 0.5rem;">
...
" alt="Sagar Cafe Logo" style="width: 40px; height: 40px; flex-shrink: 0;">
                    <div style="flex: 1; text-align: left;">
                        <h1 style="font-family: 'Playfair Display', serif; color: #2c3e50; margin: 0 0 0.25rem 0; font-size: 1.3rem; line-height: 1.2;">
                            Sagar Cafe
                        </h1>
                        <p class="tagline" style="color: #7f8c8d; font-size: 0.65rem; font-style: italic; margin: 0 0 0.3rem 0; line-height: 1.3;">
                            Where Every Wave Brings Flavor
                        </p>
                        <p style="color: #7f8c8d; font-size: 0.6rem; margin: 0 0 0.2rem 0; line-height: 1.3;">
                            📍 Jabalpur Road, Makronia, Sagar
                        </p>
                        <p style="color: #7f8c8d; font-size: 0.6rem; margin: 0; line-height: 1.3;">
                            ☎️ +91 9174849029
                        </p>
                    </div>
                </div>

                <div class="bill-info" style="margin-bottom: 0.3rem; font-size: 0.65rem; padding: 0 0.75rem; color: #2c3e50;">
                        ...
                        ${items.map(item => `
                            <tr>
                                <td style="padding: 0.3rem; border-bottom: 1px solid #dee2e6; color: #2c3e50; font-size: 0.75rem;">
                                    ${item.name}
                                    ${item.isPriceModified ? '<span style="color: #f39c12; font-size: 0.65rem;"> (Modified)</span>' : ''}
                                </td>
                ...
                <div class="bill-totals" style="margin-left: auto; width: 280px; margin-bottom: 0.3rem;">
                    ...
                    ` : ''}
                    <div class="bill-totals-total" style="border-top: 2px solid #d4af37; margin-top: 0.2rem; padding: 0.4rem 0.5rem 0.2rem 0.5rem; font-size: 1rem; font-weight: 700; color: #000; display: flex; justify-content: space-between;">
                        <span>Total:</span>
                        <span>₹${total.toFixed(2)}</span>
                    </div>
                </div>

                <div class="bill-footer" style="text-align: center; border-top: 2px solid #d4af37; padding: 0.3rem 0.75rem 0.25rem; color: #7f8c8d; font-size: 0.65rem;">
                    <p class="thank-you" style="font-size: 0.8rem; color: #d4af37; font-weight: 600; margin: 0 0 0.15rem 0; line-height: 1.2;">
                        Thank You! Visit Again! 🙏
                    </p>
                    <p style="font-size: 0.6rem; margin: 0; line-height: 1.2;">GST No: 27XXXXX1234X1ZX | FSSAI Lic: 12345678901234</p>
                    <p style="margin: 0.1rem 0; font-size: 0.55rem; line-height: 1.1;">
                        🌐 www.sagarcafe.in
                    </p>
                    <p style="margin: 0; font-style: italic; color: #95a5a6; font-size: 0.55rem; line-height: 1.1;">
